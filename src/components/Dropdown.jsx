...
const Dropdown = ({
    ...
    return (
        <div className='container relative mb-6 flex max-w-screen-sm flex-col rounded-md border bg-white p-6 '>
            ...
            {isEdit ?
                <MultipleInputBoxes handleChange={handleChange} randomId={1} options={options} isEdit={isEdit} handleEdit={handleEdit} type={'radio'} />
                :
                <div
                ...
                >
                    ...
                    <ul
                        className={`${dropdownOpen ? 'z-10 opacity-100' : '-z-10 opacity-0'
